...
public class BlockObsidianOre extends Block{
	...
	public BlockObsidianOre() {
		super(Material.ROCK);
		setUnlocalizedName(Reference.ModBlocks.OBSIDIAN_ORE.getUnlocalizedName());
		setRegistryName(Reference.ModBlocks.OBSIDIAN_ORE.getRegistryName());
	...
	public Item getItemDropped(int metadeta, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.obsidian_ore);
