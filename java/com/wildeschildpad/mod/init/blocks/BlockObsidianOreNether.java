...
public class BlockObsidianOreNether extends Block{

	public BlockObsidianOreNether() {
		super(Material.ROCK);
		setUnlocalizedName(Reference.ModBlocks.OBSIDIAN_ORE_NETHER.getUnlocalizedName());
		setRegistryName(Reference.ModBlocks.OBSIDIAN_ORE_NETHER.getRegistryName());
	...
	public Item getItemDropped(int metadeta, Random rand, int fortune) {
		return Item.getItemFromBlock(ModBlocks.obsidian_ore_nether);
